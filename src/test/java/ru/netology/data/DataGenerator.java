...
public class DataGenerator {
    ...
    public static class Registration {
        ...
        public static RegistrationInfo userValid() {
            RegistrationInfo user = new RegistrationInfo(getRandomLogin(), getRandomPassword(), "active");
            setUpAll(user);
            return user;
        }

        public static RegistrationInfo userNoValid() {
            RegistrationInfo user = new RegistrationInfo(getRandomLogin(), getRandomPassword(), "blocked");
            setUpAll(user);
            return user;
        }
